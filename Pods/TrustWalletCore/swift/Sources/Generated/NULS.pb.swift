...
extension TW_NULS_Proto_TransactionPurpose: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    6: .same(proto: "timestamp"),
    7: .same(proto: "utxos"),
    8: .standard(proto: "use_max_amount"),
  ]
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      ...
      case 8: try decoder.decodeSingularBoolField(value: &self.useMaxAmount)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    ...
    if self.useMaxAmount != false {
      try visitor.visitSingularBoolField(value: self.useMaxAmount, fieldNumber: 8)
    }
    try unknownFields.traverse(visitor: &visitor)
  }
