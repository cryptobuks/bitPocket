...
public struct TW_Tezos_Proto_Operation {
  ...
  public var originationOperationData: TW_Tezos_Proto_OriginationOperationData {
    get {
      if case .originationOperationData(let v)? = _storage._operationData {return v}
      return TW_Tezos_Proto_OriginationOperationData()
    }
    set {_uniqueStorage()._operationData = .originationOperationData(newValue)}
  }
  ...
  public enum OneOf_OperationData: Equatable {
    ...
    case originationOperationData(TW_Tezos_Proto_OriginationOperationData)
    ...
    public static func ==(lhs: TW_Tezos_Proto_Operation.OneOf_OperationData, rhs: TW_Tezos_Proto_Operation.OneOf_OperationData) -> Bool {
      ...
      case (.originationOperationData(let l), .originationOperationData(let r)): return l == r
  ...
  public enum OperationKind: SwiftProtobuf.Enum {
    ...
    public init?(rawValue: Int) {
      ...
      case 9: self = .origination
      case 10: self = .delegation
    ...
    public var rawValue: Int {
      ...
      case .origination: return 9
      case .delegation: return 10
...
/// Next field: 3
public struct TW_Tezos_Proto_OriginationOperationData {
  // SwiftProtobuf.Message conformance is added in an extension below. See the
  // `Message` and `Message+*Additions` files in the SwiftProtobuf library for
  // methods supported on all messages.

  public var managerPubkey: String = String()
...
extension TW_Tezos_Proto_Operation: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  ...
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    10: .standard(proto: "origination_operation_data"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    ...
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      while let fieldNumber = try decoder.nextFieldNumber() {
        ...
        case 10:
          var v: TW_Tezos_Proto_OriginationOperationData?
          if let current = _storage._operationData {
            try decoder.handleConflictingOneOf()
            if case .originationOperationData(let m) = current {v = m}
          }
          try decoder.decodeSingularMessageField(value: &v)
          if let v = v {_storage._operationData = .originationOperationData(v)}
        case 11:
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    try withExtendedLifetime(_storage) { (_storage: _StorageClass) in
      ...
      case .originationOperationData(let v)?:
...
extension TW_Tezos_Proto_Operation.OperationKind: SwiftProtobuf._ProtoNameProviding {
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    ...
    9: .same(proto: "ORIGINATION"),
    10: .same(proto: "DELEGATION"),
  ]
}
...
extension TW_Tezos_Proto_OriginationOperationData: SwiftProtobuf.Message, SwiftProtobuf._MessageImplementationBase, SwiftProtobuf._ProtoNameProviding {
  public static let protoMessageName: String = _protobuf_package + ".OriginationOperationData"
  public static let _protobuf_nameMap: SwiftProtobuf._NameMap = [
    1: .standard(proto: "manager_pubkey"),
  ...
  public mutating func decodeMessage<D: SwiftProtobuf.Decoder>(decoder: inout D) throws {
    while let fieldNumber = try decoder.nextFieldNumber() {
      switch fieldNumber {
      case 1: try decoder.decodeSingularStringField(value: &self.managerPubkey)
      case 2: try decoder.decodeSingularInt64Field(value: &self.balance)
      default: break
      }
    }
  }
  ...
  public func traverse<V: SwiftProtobuf.Visitor>(visitor: inout V) throws {
    if !self.managerPubkey.isEmpty {
      try visitor.visitSingularStringField(value: self.managerPubkey, fieldNumber: 1)
    }
    if self.balance != 0 {
  ...
  public static func ==(lhs: TW_Tezos_Proto_OriginationOperationData, rhs: TW_Tezos_Proto_OriginationOperationData) -> Bool {
    if lhs.managerPubkey != rhs.managerPubkey {return false}
